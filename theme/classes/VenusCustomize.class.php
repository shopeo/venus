		...
		public static function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'header_footer_background_color',
					array(
						'label'   => __( 'Header &amp; Footer Background Color', 'venus' ),
						'section' => 'colors',
					)
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					'type'    => 'radio',
					'section' => 'colors',
					'label'   => __( 'Primary Color', 'venus' ),
					'choices' => array(
						'default' => _x( 'Default', 'color', 'venus' ),
						'custom'  => _x( 'Custom', 'color', 'venus' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'section'         => 'colors',
						'settings'        => 'accent_hue',
						'description'     => __( 'Apply a custom color for links, buttons, featured images.', 'venus' ),
						'mode'            => 'hue',
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'Show author bio', 'venus' ),
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'On archive pages, posts show:', 'venus' ),
					'choices'  => array(
						'full'    => __( 'Full text', 'venus' ),
						'summary' => __( 'Summary', 'venus' ),
					),
				)
			);
			...
			$wp_customize->add_section(
				...
				array(
					'title'       => __( 'Cover Template', 'venus' ),
					'capability'  => 'edit_theme_options',
					'description' => __( 'Settings for the "Cover Template" page template. Add a featured image to use as background.', 'venus' ),
					'priority'    => 42,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'       => __( 'Fixed Background Image', 'venus' ),
					'description' => __( 'Creates a parallax effect when the visitor scrolls.', 'venus' ),
				)
			);
			...
			$wp_customize->add_setting(
				...
				array(
					'default'           => venus_get_color_for_area( 'content', 'accent' ),
					'sanitize_callback' => 'sanitize_hex_color',
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_background_color',
					array(
						'label'       => __( 'Overlay Background Color', 'venus' ),
						'description' => __( 'The color used for the overlay. Defaults to the accent color.', 'venus' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_text_color',
					array(
						'label'       => __( 'Overlay Text Color', 'venus' ),
						'description' => __( 'The color used for the text in the overlay.', 'venus' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				'cover_template_overlay_opacity',
				array(
					'label'       => __( 'Overlay Opacity', 'venus' ),
					'description' => __( 'Make sure that the contrast is high enough so that the text is readable.', 'venus' ),
					'section'     => 'cover_template_options',
					'type'        => 'range',
					'input_attrs' => venus_customize_opacity_range(),
				)
			);
