...
if ( ! class_exists( 'VenusNonLatinLanguages' ) ) {
	class VenusNonLatinLanguages {
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'venus_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'venus_get_localized_font_family_elements',
				array(
					'front-end'      => array(
						'body',
						'input',
			...
			return venus_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
		}
	}
}
