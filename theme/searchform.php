...
<form role="search" <?php echo $venus_aria_label; ?> method="get" class="search-form w-full"
	...
	<label class="relative" for="<?php echo esc_attr( $venus_unique_id ); ?>">
		...
		<input type="text" id="<?php echo esc_attr( $venus_unique_id ); ?>"
			   class="search-field w-full h-8 rounded-full pl-10 bg-neutral-50 placeholder-neutral-400 border border-neutral-100 focus:border-primary-500 focus:ring-0"
